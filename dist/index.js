...
export function createCailClient(opts) {
    ...
    try {
        ...
        throw new CailError("invalid_config", `createCailClient requires an absolute \`baseUrl\` URL; ${JSON.stringify(opts.baseUrl)} does not parse (new URL threw).`, 0);
    }
    ...
    async function call(path, init, credential, options, internal) {
        ...
        const retrySafeMethod = IDEMPOTENT_HTTP_METHODS.has(method) || wireIdempotencyKey !== undefined;
        ...
        for (;;) {
            ...
            try {
                ...
                throw new CailError("network_error", err instanceof Error && err.message
                    ? err.message
